...
\ifdefined\chs
这话说得甚是坦白。显然，斯托曼不是个和平主义者。随着矛盾的升级，给双方带来的情感变化也逐渐加大。通言是来自哈维·纽奎斯特的说辞，斯托曼当年甚至发了一封邮件，扬言要``浑身绑满炸弹冲进Symbolics的办公室''\footnote{参见H. P. 纽奎斯特 (H. P. Newquist)所著的《大脑创作家》（The Brain Maker）。原文中提到：``斯托曼的这言论在Symbolics员工那里倒是引起了点注意。不过最后还没没人把他的话太当真。''}。斯托曼则否认发过这样的邮件，并且说这完全是``恶毒的谣言''。不过他倒是承认有过这种极端想法：``我倒是的确幻想过要自杀式袭击毁掉他们的办公楼。''\endnote{参见\url{http://www.as.cmu.edu/~geek/humor/See_Figure_1.txt}}
\fi
\fi
