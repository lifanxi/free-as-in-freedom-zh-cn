...
\ifdefined\chs
“不完美的系统会激怒黑客”，史蒂芬·李维说过，这是我决定与斯托曼同坐一辆车前应该听取的另一个忠告。“这是黑客们通常不喜欢开车的原因之一：这是一个充满不确定性的程序，交通信号灯总是随机的变化，还有横七竖八的单行道，导致交通经常堵塞。这实在是太\textit{不必要}了（李维强调说），只要让黑客们重新安排一下信号灯，打开交通灯控制盒，重新设计整个系统。” \endnote{参考史蒂芬·李维的《\textit{黑客}》一书（企鹅出版社，美国，平装，1984年）第40页。}
\fi
